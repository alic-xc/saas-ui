    ...
    return (
        <section className='grid grid-cols-12 gap-x-10 bg-white lg:px-[15%] md:px-[5%] px-[15%] p-20'>
            ...
            <section className="col-span-4 sm:col-span-12 xs:col-span-12 flex flex-col shadow-lg p-10">
                ...
                <a href="#" className="font-semibold flex justify-start place-items-center hover:text-[#7052fb]"><span className='mr-3'>Find Out More</span> <BsArrowRight /></a>            
            </section>
            <section className="col-span-4 sm:col-span-12 xs:col-span-12 flex flex-col shadow-lg p-10">
                <AiOutlineRocket className='text-[#7052fb] text-[48px] border-2 border-[#7052fb] rounded-full w-16 h-16 p-2'  />
    ...
    return (
        <section className='grid grid-cols-12 gap-x-10 bg-[#faf9ff] lg:px-[15%] md:px-[5%] px-[10%] p-20'>
            ...
            <section className='col-span-5 sm:col-span-12 xs:col-span-12 flex justify-center place-items-center'>
                <img src={require('../assets/images/tablet.png')} className='w-[400px]' />
            </section>
                ...
                <div className=''>
                    <div className='flex place-items-center mb-8 sm:mt-10 xs:mt-10'>
                        <div className='shadow-lg p-5 rounded-[10px] mr-8'>
                            <img src={require('../assets/images/22.png')} width={35} />
                        </div>
                        <a href="#" className='text-[20px]'>Show off show off pick your nose and<br className='hidden lg:block md:block'/> blow off grub so I said pardon.</a>
                    </div>
                    <div className='flex place-items-center mb-5'>
                        <div className='shadow-2xl p-5 rounded-[10px] mr-8'>
                            <img src={require('../assets/images/23.png')} width={35} />
                        </div>
                        <a href="#" className='text-[20px]'>Daft blimey squiffy lemon squeezy <br className='hidden lg:block md:block'/>Richard bite your arm.</a>
                    </div>
                    <div className='flex place-items-center mb-5'>
                        <div className='shadow-2xl p-5 rounded-[10px] mr-8'>
                            <img src={require('../assets/images/24.png')} width={35} />
                        </div>
                        <a href="#" className='text-[20px]'>Lost the plot don't get shirty with me <br className='hidden lg:block md:block'/>cheeky bugger.</a>
                    </div>
                    <div className='flex place-items-center mb-5'>
                        <div className='shadow-2xl p-5 rounded-[10px] mr-8'>
                            <img src={require('../assets/images/25.png')} width={35} />
                        </div>
                        <a href="#" className='text-[20px]'>Cup of char horse play excuse my <br className='hidden lg:block md:block'/>French sloshed butty.</a>
                    </div>
                </div>
            </section>
        </section>
        ...
        <section className='grid grid-cols-12 gap-x-10 bg-[#fff] lg:px-[15%] md:px-[5%] px-[15%] p-20'>
            <div className='lg:col-span-6 md:col-span-6 col-span-12 flex flex-col place-content-center '>
                <div className='pr-20'>
                    ...
                    <a href="#" className='p-3 px-8 text-[14px] hover:bg-[#7052fb] hover:text-white text-[#7052fb] border-[#7052fb] mt-5 rounded-full border inline-block'>View More</a>
                </div>
            </div>
            <div className='lg:col-span-6 md:col-span-6 col-span-12 overflow-hidden'>
                <div className='flex'>
                    <img src={require("../assets/images/27.png")}  alt="" className=""/>
                    <img src={require("../assets/images/26.png")} alt="" className=""/>
                </div>
    ...
    return (
        <section className='grid grid-cols-12 gap-x-10 bg-[#fff] lg:px-[15%] md:px-[5%] px-[15%] p-20'>
            <div className='lg:col-span-7 md:col-span-7 col-span-12  relative h-auto'>
                <img src={require("../assets/images/29.png")}  alt="" className="mx-auto"/>
                <img src={require("../assets/images/28.png")} alt="" className="absolute top-1/2"/>
            </div>
            <div className='lg:col-span-5 md:col-span-5 col-span-12 sm:mt-20 xs:mt-20 flex flex-col place-content-center'>
                <div className='pr-20'>
                    ...
                    <a href="#" className='p-3 px-8 text-[14px] hover:bg-[#7052fb] hover:text-white text-[#7052fb] border-[#7052fb] mt-5 rounded-full border inline-block'>Discover More</a>
                </div>
            </div>
...
const SixthSection = () => {
    return (
        <section className='grid grid-cols-12 gap-x-10 bg-[#fff] lg:px-[15%] md:px-[5%] px-[15%] p-20'>
            ...
            <div className='lg:col-span-7 md:col-span-7 col-span-12  relative h-auto'>
                <img src={require("../assets/images/1.png")}  alt="" className="relative z-[10000000]"/>
                <img src={require("../assets/images/2.png")} alt="" className="absolute top-0 right-[21%]"/>
            </div>
    ...
    return (
        <section className='grid grid-cols-12 gap-x-10 bg-[#fff] lg:px-[15%] md:px-[5%] px-[15%] p-20'>
            ...
            <div className="col-span-6 sm:col-span-12 xs:col-span-12">
                <img src={require('../assets/images/23.jpeg')} className="rounded-[5px] w-auto" />
                <div>
            ...
            <div className="col-span-6 sm:col-span-12 xs:col-span-12">
                <img src={require('../assets/images/24.jpeg')} className="rounded-[5px] w-auto" />
                <div>
                    <div className='my-3 text-[#555]'>
                        <span className='pr-5 border-r-[2px] border-[#555]'>By Admin</span>
                        <span className="pl-5">Jul 24, 2019</span>
